...
(async () => {
  ...
  await fs.writeFile("allergic-and-chronic-rhinitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("allergic-and-chronic-rhinitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
